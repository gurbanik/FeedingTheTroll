...
function setup() {
  ...
  troll.scale = 2
  troll.setCollider("rectangle", 0, 0, 30, 45)
  //troll.debug = true
...
function spawnbush(){
  if(frameCount%109==0){
    ...
    bushGrp.add(bush)
    //bush.debug = true 
    bush.setCollider("rectangle", 0, 0, 180, 140)
  }
}
...
function spawnlog(){
  if(frameCount%180==0){
    ...
    logGrp.add(log)
    //log.debug=true
    log.setCollider("rectangle", 0, 0, 200, 150)
  }
}
...
function spawnapple(){
  if(frameCount%100==0){
    ...
    appleGrp.add(apple)
    //apple.debug = true
    apple.setCollider("circle", 0, 0, 125)
  }
}  
...
function spawnbananna(){
  if(frameCount%170==0){
    ...
    //bananna.debug= true
    bananna.setCollider("rectangle", 0, 0, 30, 50)
  }
}  
